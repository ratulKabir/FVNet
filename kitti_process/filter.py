...
def filter(label_file, det_file):
    ...
    for det, label in zip(dets, labels):
        ...
        img_id = det_split[0]
        cls = det_split[1]
        pc_velo_path = '/home/ubuntu/workstation/data/dataset/kitti_fvnet2/refinement/training/cropped/' + img_id + ".npy"
...
if __name__ == '__main__':
    train_label_file = '/home/ubuntu/workstation/data/dataset/kitti_fvnet2/refinement/list_files/label_train.txt'
    train_det_file = '/home/ubuntu/workstation/data/dataset/kitti_fvnet2/refinement/list_files/det_train.txt'

    val_label_file = '/home/ubuntu/workstation/data/dataset/kitti_fvnet2/refinement/list_files/label_val.txt'
    val_det_file = '/home/ubuntu/workstation/data/dataset/kitti_fvnet2/refinement/list_files/det_val.txt'
