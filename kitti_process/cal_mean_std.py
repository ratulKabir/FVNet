...
filepath = '/home/ratul/data/dataset/kitti_fvnet2/projection'
training_set = glob.glob(os.path.join(filepath, 'training', 'images_256', '*.png'))  # changed 512 to 256
testing_set = glob.glob(os.path.join(filepath, 'testing', 'images_256', '*.png'))  # changed 512 to 256
