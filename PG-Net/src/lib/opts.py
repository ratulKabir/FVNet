...
class opts(object):
    def __init__(self):
        ...
        self.parser.add_argument('--task', default='fvdet',
                                 help='ctdet | exdet | fvdet')
        self.parser.add_argument('--dataset', default='fv2',
                                 help='coco | pascal | fv | fv2')
        ...
        self.parser.add_argument('--demo', default='',
                                 help='path to image/ image folders/ video. '
                                      'or "webcam"')
        self.parser.add_argument('--load_model', default='/home/ubuntu/workstation/FVNet/PG-Net/exp/fvdet/default/model_best.pth',
        ...
        self.parser.add_argument('--num_epochs', type=int, default=100000,
                                 help='total training epochs.')
        self.parser.add_argument('--batch_size', type=int, default=32,  # 32
                                 help='batch size')
        ...
        self.parser.add_argument('--dep_iou_weight', type=float, default=1,
                                 help='loss weight for depth iou.')
        # task
        # ctdet
    ...
    def parse(self, args=''):
        ...
        opt.data_dir = '/home/ubuntu/workstation/data/dataset'
...
if __name__ == '__main__':
    print(os.path.exists('/home/ubuntu/workstation/FVNet/PG-Net/exp/fvdet/default/model_best.pth'))
